package com.jy.recycler.adapter;
...
import com.jy.recycler.helper.ItemTouchHelperAdapter;
import com.jy.recycler.helper.OnStartDragListener;
import com.jy.recycler.helper.SimpleItemTouchHelperCallback;
import com.jy.recycler.listener.OnItemMoveListener;
...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder>
     ...
     *
     * @param holder
     *      出现Bug的特定bug的时候，该列表项滑动出可视界面，但是滑动距离不长，长的话再复用View执行onBindViewHolder()方法。
    　　解决方法就是在RecyclerView中重写onViewDetachedFromWindow()方法，进行一个相应的操作（初始化等等）。
     */
    @Override
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case FOOTER_VIEW:
                ...
                break;
            default:
                baseViewHolder = onCreateDefViewHolder(parent, viewType); // 创建BaseViewHolder
                // 设置用于单项刷新的tag标识
