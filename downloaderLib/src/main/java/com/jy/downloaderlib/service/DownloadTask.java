package com.jy.downloaderlib.service;

import android.os.Process;
import android.os.SystemClock;

import com.jy.downloaderlib.DownloadListener;
import com.jy.downloaderlib.db.FileDAOImpl;
import com.jy.downloaderlib.entity.FileInfo;
import com.jy.downloaderlib.exception.DownloadException;
import com.jy.downloaderlib.model.DownloadStatus;
import com.jy.downloaderlib.model.FileUtils;
...
public class DownloadTask implements Runnable {
    ...
    private void _onDownload(Response response) throws Throwable {
        ...
        // 随机存储文件，根据路径+文件名.tmp可以得到这个文件的位置，mFileInfo.getLoadBytes() 可以得到这个文件已经下载多少了，mFileInfo.getTotalBytes() 表示整个文件的大小
        ...
        try {
            ...
            // 8.判断下载成功还是失败
            //如果加载的loadBytes大小等于整个文件的大小，表示下载完成。
    ...
    private void _onComplete() {
        ...
        mListener.onComplete(mFileInfo);//回调
//        // 下载完就从数据库删除
